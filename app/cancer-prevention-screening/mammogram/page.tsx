  ...
  return <>
    ...
    <div id="article-contents" className="container-page grid items-start gap-10 pb-20 lg:grid-cols-[17rem_minmax(0,48rem)] lg:justify-center lg:gap-14">
      ...
      <article className="health-prose min-w-0">
        ...
        <section id="official-resources"><h2>13. Official NHS Resources</h2><p>Use these sources for current appointment instructions and result pathways. Arrangements differ across UK nations.</p><ResourceList resources={officialMammogramResources}/><p>For wider symptom-awareness information, read the <Link href="/cancer-prevention-screening/cancer-symptoms" className="health-inline-link">Cancer Symptoms guide</Link>.</p></section>
