import { BarChart3, Compass, Eye, Handshake, Heart, Lightbulb, Linkedin, Route, Scale, ShieldCheck, Sparkles, Users } from "lucide-react";
...
export default function About() {
  return <>
    <PageStructuredData name="About BloomShield CIC" description={description} path="/about" breadcrumb="About" kind="about" />
    <AboutHero />
