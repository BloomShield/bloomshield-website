...
export default function Home() {
  return <>
    ...
    <section className="pb-20 md:pb-28"><div className="container-page"><div className="grid gap-6 rounded-4xl border border-[#4f61cd]/25 bg-gradient-to-br from-[#f7f8ff] to-[#e1e5ff] p-8 sm:p-10 lg:grid-cols-[1fr_auto] lg:items-center"><div><p className="text-xs font-bold uppercase tracking-[.18em] text-[#4051b5]">Programme Portfolio · Volume 3</p><h2 className="mt-4 font-display text-3xl font-semibold text-[#293474]">ScreenConnect™</h2><p className="mt-3 max-w-3xl text-lg leading-8 text-[#4a4f73]">The patient-navigation and care-coordination layer that helps people stay connected from screening through treatment and follow-up.</p></div><Link href="/programmes/screenconnect" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#4051b5] px-6 py-3 text-sm font-bold text-white transition hover:bg-[#293474]">Explore ScreenConnect™ <ArrowRight size={17}/></Link></div></div></section>
    <CTA/>
  </>;
}
