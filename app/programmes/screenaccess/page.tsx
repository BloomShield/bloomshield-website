...
export default function ScreenAccess() {
  return <>
    ...
    <section className="section-space bg-[#4b211a] text-white"><div className="container-page grid gap-6 lg:grid-cols-2"><article className="rounded-3xl border border-[#ffd8ca]/15 bg-white/[.06] p-8 sm:p-10"><p className="screenaccess-dark-eyebrow">Vision</p><h2 className="font-display text-3xl font-semibold">Equitable access for every eligible person.</h2><p className="mt-5 text-lg leading-8 text-white/75">To ensure that every eligible person has equitable access to evidence-based cancer screening regardless of geography, socioeconomic circumstances, ethnicity, disability, digital literacy or other barriers.</p></article><article className="rounded-3xl border border-[#ffd8ca]/15 bg-white/[.06] p-8 sm:p-10"><p className="screenaccess-dark-eyebrow">Mission</p><h2 className="font-display text-3xl font-semibold">Remove barriers through partnership.</h2><p className="mt-5 text-lg leading-8 text-white/75">To work with communities, healthcare providers, commissioners, employers and policymakers to identify, understand and remove barriers that prevent people from participating in life-saving screening programmes.</p></article></div></section>
